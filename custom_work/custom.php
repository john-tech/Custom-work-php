 ...
 <body>
      <div class="container">
           ...
           <div class="form-group">
                ...
                <input type="text" name="post_title" id="post_title" class="form-control" value="abc" />
           </div>
           <div class="form-group">
                <label>Enter Post Description</label>
                <textarea name="post_description" id="post_description" rows="6" class="form-control">xyz</textarea>
           </div>
           <div class="form-group">
